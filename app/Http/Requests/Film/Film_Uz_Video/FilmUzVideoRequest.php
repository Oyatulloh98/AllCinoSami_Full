...
namespace App\Http\Requests\Film\Film_Uz_Video;

use Illuminate\Foundation\Http\FormRequest;

class FilmUzVideoRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'part' => 'required|numeric', // Replace 'your_table_name_here' with the actual table name
