    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('RussianSerialVideo.index', $serial->id) }}">Seriallar</a></li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
        ...
        <section class="section dashboard">
            <div class="card col-8 offset-2">
                <div class="card-body">
                    <h5 class="card-title">Serials Form only russion serial create</h5>

                    <!-- Vertical Form -->
                    <form id="form" class="row g-3" action="{{ route('RussianSerialVideo.store', $serial->id) }}"
        ...
        <script>
            ...
            serial.addEventListener('input', function(event) {
                ...
                // So'rovni yuborish
                axios.get('http://127.0.0.1:8000/api/serial_russian_video_suitable_recipient', {
                        params: {
                            RuserialId: serialId,
                            part: value
                        }
