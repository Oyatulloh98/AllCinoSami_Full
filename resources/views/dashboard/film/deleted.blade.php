                                    ...
                                    @if ($films && count($films) > 0)
                                        @foreach ($films as $film)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('uzserialvideo.index', $film->id) }}"
                                                        class="badge bg-info">
                                                        <i>uz</i>
                                                    </a>
                                                    <a href="{{ route('ruserialvideo.index', $film->id) }}"
                                                        class="badge bg-info">
                                                        <i>ru</i>
                                                    </a>
                                                </td>
                                                ...
                                                <td>
                                                    <span class="badge bg-success">
                                                        <i class="ri-24-hours-fill restore-film"
                                                            id="{{ $film->id }}"></i>
                                                    </span>
                                                </td>
                                                <td>
                                                    ...
                                                    <span class="badge bg-danger">
                                                        <i class="ri-delete-bin-2-fill remove-film"
                                                            id="{{ $film->id }}"></i>
                                                    </span>
                                                </td>
                                            </tr>
