    ...
    <main id="main" class="main">
        ...
        <section class="section dashboard">
            <div class="card col-8 offset-2">
                <div class="card-body">
                    <h5 class="card-title">Films Form only uzbek film update</h5>

                    <!-- Vertical Form -->
                    <form id="form" class="row g-3" action="{{ route('UzbekFilmVideo.update', $uz_film->id) }}"
                        ...
                        <div class="col-12">
                            <label for="inputSerialNanme4" class="form-label">Film nomi uz :
                                {{ $uz_film->film_for_uz_film->name_uz }}</label>
                        ...
                        <div class="col-12">
                            <label for="inputSerialName4" class="form-label">Film nomi ru :
                                {{ $uz_film->film_for_uz_film->name_ru }}</label>
                        ...
                        <div class="col-12">
                            <input type="hidden" id="video_id" value="{{ $uz_film->id }}">
                            <input type="hidden" id="film_id" value="{{ $uz_film->film_for_uz_film->id }}">
                            <label for="inputSerialNanme4" class="form-label">Film qismi: {{ $uz_film->part }}</label>
        ...
        <script>
            ...
            film_part.addEventListener('input', function(event) {
                ...
                // So'rovni yuborish
                axios.get('http://127.0.0.1:8000/api/film_uzbek_video_for_update_get_part', {
                        params: {
                            film_id: filmId,
                            video_id: videoId,
                            part: value
