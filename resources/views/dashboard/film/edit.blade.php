        ...
        <section class="section dashboard">
            <div class="card col-8 offset-2">
                <div class="card-body">
                    ...
                    <!-- Vertical Form -->
                    <form class="row g-3" action="{{ route('films.update', $film->id) }}" enctype="multipart/form-data"
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" name="name_uz" value="{{ old('name_uz', $film->name_uz) }}"
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" name="name_ru" value="{{ old('name_ru', $film->name_ru) }}"
                        ...
                        <div class="col-12">
                            <label for="inputSerialNanme4" class="form-label">Film rasmi: <a
                                    href="{{ $film->filmImagePath() }}{{ $film->film_image[0]['path'] }}">
                                    <img src="{{ $film->filmImagePath() }}{{ $film->film_image[0]['path'] }}"
                                        alt="{{ $film->name_uz }}" srcset="" width="30" height="30">
                                </a></label>
